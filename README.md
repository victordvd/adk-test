...
<img src="gpt_architecture.png" alt="LLM Auditor Architecture" width="800"/>
...
You may open the URL, select chimei_gpt_agent in the top-left drop-down menu, and
...
from gpt.agent import root_agent
